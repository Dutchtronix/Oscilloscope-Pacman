...
The subdirectory "logic" runs on a standard ATmega1284P microcontroller but it will also work on smaller ATmegas since the code and ram requirements are minimal. In 2 player mode, the AVR will need 2 serial ports. Both AVRs run at 20 MHz.
